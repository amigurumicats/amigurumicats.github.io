var vm = new Vue({
  ...
  data: {
    ...
    allItemList: [  // 全てのitem
      ...
      {id: 6, path: "/webapp/", text: "Pikmin Bloom デコチェッカー", description: "純js製なのでクライアントだけで動く。全然更新してない。", icon_img: "img/icon_file.png", icon_img_hover: "img/icon_file.png", link: "pikmin_bloom_checker"},
      {id: 7, path: "/webapp/", text: "TimerTA", description: "ストップウォッチがサボってないか監視するゲーム", icon_img: "img/icon_file.png", icon_img_hover: "img/icon_file.png", link: "timerTA"},
      // {id: 100, path: "/playable/", text: 'cursor', description:'死ぬほど動作不安定。解けなくてもだいたい環境のせい。', icon_img: 'img/icon_file.png', icon_img_hover: 'img/icon_file.png', link: 'cursor/cursor.html'},
    ],
    itemList: []  // 表示されるitem
  },
  methods: {
